...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QSize(250, 275))
        ...
        self.opacityLineEdit = QLineEdit(self.opacityFrame)
        self.opacityLineEdit.setObjectName(u"opacityLineEdit")
        self.opacityLineEdit.setMaximumSize(QSize(64, 16777215))

        self.horizontalLayout.addWidget(
            self.opacityLineEdit, 0, Qt.AlignmentFlag.AlignRight)
        ...
        self.maxSuggestionComboBox.setMaximumSize(QSize(64, 16777215))
        ...
        self.languageComboBox.setMaximumSize(QSize(64, 16777215))
        ...
        self.clientTypeComboBox.setMaximumSize(QSize(64, 16777215))
        ...
        self.regionComboBox.setMaximumSize(QSize(64, 16777215))
        ...
        self.autoVoiceSearchBomboBox.setMaximumSize(QSize(64, 16777215))
        ...
        MainWindow.setcenterwidget(self.centerwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.clientTypeComboBox.setItemText(
            0, QCoreApplication.translate("MainWindow", u"Mozilla", None))
